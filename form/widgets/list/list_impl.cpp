/*
** list_impl.cpp - list widget implementation
**
...
public:
	list_impl(liblec::lecui::widgets::page& page) :
		page_(page) {}
	liblec::lecui::widgets::page& page_;
};

liblec::lecui::widgets::list::list(liblec::lecui::widgets::page& page) :
...
liblec::lecui::widgets_implementation::list::~list() {
	discard_resources();
	log("destructor: " + page_ + ":" + name_);
}

std::string liblec::lecui::widgets_implementation::list::name() { return name_; }
std::string liblec::lecui::widgets_implementation::list::page() { return page_; }

liblec::lecui::widgets_implementation::widget_type
liblec::lecui::widgets_implementation::list::type() {
	return lecui::widgets_implementation::widget_type::list;
}

HRESULT liblec::lecui::widgets_implementation::list::create_resources(
...
void liblec::lecui::widgets_implementation::list::on_click() {
...
bool liblec::lecui::widgets_implementation::list::on_mousewheel(float units) {
...
bool liblec::lecui::widgets_implementation::list::on_keydown(WPARAM wParam) {
...
bool liblec::lecui::widgets_implementation::list::hit(const bool& hit) {
...
liblec::lecui::widgets::specs::list&
liblec::lecui::widgets_implementation::list::specs() { return specs_; }

void liblec::lecui::widgets_implementation::list::on_selection() {
	if (specs_.on_selection) {
