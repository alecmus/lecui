	...
	namespace lecui {
		namespace widgets {
			...
			public:
				...
				/// <summary>Get or set time widget events.</summary>
				/// <returns>A reference to the widget events.</returns>
				time_events& events() {
					return _time_events;
				}
			...
			private:
				/// <summary>Time widget events.</summary>
...
/// Helper for getting time widget. 'Get' method documentation applies.
