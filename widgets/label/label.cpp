		...
		public:
			impl(containers::page& page, const std::string& alias) :
				...
				_specs
					...
					.color_selected(defaults::color(_page._d_page._fm._d._theme, element::label_selected))
					.color_hot(defaults::color(_page._d_page._fm._d._theme, element::label_hover))
					.color_hot_pressed(defaults::color(_page._d_page._fm._d._theme, element::label_pressed))
					.color_disabled(defaults::color(_page._d_page._fm._d._theme, element::label_disabled));
			}
