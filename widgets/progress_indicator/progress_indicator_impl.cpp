...
namespace liblec {
	namespace lecui {
		widgets_impl::progress_indicator_impl::progress_indicator_impl(containers::page& page,
		...
		widgets_impl::progress_indicator_impl::~progress_indicator_impl() { discard_resources(); }

		widgets_impl::widget_type
			widgets_impl::progress_indicator_impl::type() {
			return lecui::widgets_impl::widget_type::progress_indicator;
		}

		HRESULT widgets_impl::progress_indicator_impl::create_resources(
		...
		void widgets_impl::progress_indicator_impl::discard_resources() {
		...
		D2D1_RECT_F&
			widgets_impl::progress_indicator_impl::render(ID2D1HwndRenderTarget* p_render_target,
		...
		void widgets_impl::progress_indicator_impl::on_click() {
			if (specs_.events().click)
				specs_.events().click();
		}

		widgets::progress_indicator::progress_indicator_specs&
			widgets_impl::progress_indicator_impl::specs() { return specs_; }

		widgets::progress_indicator::progress_indicator_specs&
			widgets_impl::progress_indicator_impl::operator()() { return specs(); }
	}
}
