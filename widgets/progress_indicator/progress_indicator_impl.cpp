...
liblec::lecui::widgets_implementation::progress_indicator::progress_indicator(const std::string& page,
...
liblec::lecui::widgets_implementation::progress_indicator::~progress_indicator() {
	discard_resources();
	log("destructor: " + page_ + ":" + name_);
}

std::string liblec::lecui::widgets_implementation::progress_indicator::name() { return name_; }
std::string liblec::lecui::widgets_implementation::progress_indicator::page() { return page_; }

liblec::lecui::widgets_implementation::widget_type
liblec::lecui::widgets_implementation::progress_indicator::type() {
	return lecui::widgets_implementation::widget_type::progress_indicator;
}

HRESULT liblec::lecui::widgets_implementation::progress_indicator::create_resources(
...
void liblec::lecui::widgets_implementation::progress_indicator::discard_resources() {
...
D2D1_RECT_F&
liblec::lecui::widgets_implementation::progress_indicator::render(ID2D1HwndRenderTarget* p_render_target,
...
void liblec::lecui::widgets_implementation::progress_indicator::on_click() {
	if (specs_.on_click)
		specs_.on_click();
}

liblec::lecui::widgets::specs::progress_indicator&
liblec::lecui::widgets_implementation::progress_indicator::specs() { return specs_; }
